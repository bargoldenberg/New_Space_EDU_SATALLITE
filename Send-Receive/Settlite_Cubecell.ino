...
void loop()
{
  ...
  if (loraReq.length()){
    ...
    Serial.println("Waiting for response from nanopi...");
    if (SERIAL_PORT.available() > 0){
      ...
      if(response.length()>1){
        ...
        if(response.equals("im awake")){
          Serial.print("got awake signal");
          SERIAL_PORT.println(loraReq);
        }
